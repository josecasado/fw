...
def menu():
    while True:
        print "\n" + "                          ACI INSERCION AUTOMATICA DE SERVICIOS DE SEGURIDAD" + "\n"
        print "\n" + "  Elije Servicio de Seguridad: Proteger Perimetro WEB o Base de datos -- (numero o 'q' para salir)" + "\n"
        option = raw_input("                       1) FW Perimetral Web " + "\n" + "                       2) FW in Deep Base de Datos" + "\n" + "\n" + "                          Introduzca opcion:")
        if option == "1":
            token = True
            print "\n" + "                Elije Servicio de FW Perimetral:  -- (numero o 'q' para salir)" + "\n"
            option1 = raw_input("                       1) FW Perimetral PLATINO ASA 5515 " + "\n" + "                       2) FW Perimetral ORO ASA virtual" + "\n" + "\n" + "                          Introduzca opcion:")
            while token:
                if option1 == "1":
                    asaphy_ext()
                    token = False
                    ...
                    token = False
                    print "     Error salaete, 1,2 o q"
        elif option == "2":
            token = True
            print "\n" + "                Elije Servicio de FTD Internal:  -- (numero o 'q' para salir)" + "\n"
            option1 = raw_input("                       1) FTD no gestionado " + "\n" + "                       2) FTD Gestionado por APIC" + "\n" + "\n" + "                          Introduzca opcion:")
            while token:
                if option1 == "1":
                    ftd_int()
                    token = False
...
# function to create the output file wit all the tenant parameters to send to apic
...
# function to insert ASAv pbr external
...
def asaphy_ext():
    ...
    if response:
        # print "\n" + "***************** Insertado pbr_ext" + "\n"
        raw_input("Press Enter to insert ASA_PHY_device and service graph...")
...
def ftd_int():
    ...
    if response:
        # print "\n" + "***************** Insertado pbr_ext" + "\n"
        raw_input("Press Enter to insert FTD_device and service graph...")
    ...
    os.remove("output")
    if response:
        print "\n" + "***************** Preparado FTD_service_graph con EXITO" "\n"
        raw_input("Press Enter to apply service graph in contract bd...")
    ...
    os.remove("output")
    if response:
        print "\n" + "***************** Aplicado FTD_service_graph con EXITO"
...
def ftd_int_dp():
    ...
    if response:
        # print "\n" + "***************** Insertado pbr_ext" + "\n"
        raw_input("Press Enter to insert FTD_device Managed and service graph...")
    ...
    if response:
        ...
        raw_input("Press Enter to apply service graph protegiendo a la Base de Datos...")
